...
/*  async questioning(question)
  {
    ...
    // Had trouble with a double input, this is because when I create a new instance of rl, it will stack. leading to double inputs
    // Later on in the line find an alternative, just in case
  ...
  async pathHandler()
  {
    ...
    return this.questioning("Insert Path Here : ");
  ...
  async aquireLoginDetails() 
  {
    ...
    if(await this.verifyUsername(username) == false)
    {
