...
class pup
{
  ...
  {    
          ...
          Before launching a browser, we must check if there is even a directory of files I can choose from.


          Also validate the cookie, don't just assume it'll work. Sometimes logging out can refresh cookies and leave old ones useless.
...
`
  ...
  // End goal, setting path to a local variable.
  async pathManager()
  {
     This function is in charge of two things, updatting a path and creating a path.
  }

  async cookieManager()
  {
     This function handles cookie expiring, and creating the file.
  }
